...
//	}
	...
	@GetMapping(value = "listByGoods") // LCRUD 에서 L:list
	public void listByGoods(@RequestParam("boardId") int boardId,
			@ModelAttribute("pagination") Criteria userCriteria,
			@AuthenticationPrincipal Principal principal, Model model) {
	...
	public String batchDeletePost(@RequestParam("boardId") int boardId, 
			@RequestParam("postId") ArrayList<String> postIds,
			RedirectAttributes rttr, Criteria fromUser,  String writerId) {
