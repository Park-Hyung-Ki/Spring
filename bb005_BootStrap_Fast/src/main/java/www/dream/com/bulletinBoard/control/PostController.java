...
public class PostController {
	...
	/*@GetMapping(value="modifyPost") // 수정이라는 기능을 불러오는것을 만듬 0526
	//readPost와 거의 동일한 구성이라고 봐도 무방하다.
	public void openModifyPost(@RequestParam("boardId") int boardId, 
			@RequestParam("postId") String id, Model model) {
		model.addAttribute("post", postService.findPostById(id));
		model.addAttribute("boardId", boardId);
	}*/
	...
	public String openModifyPost(@RequestParam("boardId") int boardId,
